...
let item1 = new CreateItem(1, 'Baggy Multi-Pocket Jean', 'Casual','https://sihlandlo-schillo.github.io/HOSTEDIMAGES/images/Yolanda.jpg','', 'Electric Guitar 39 Inch Set - Black', 2999 )

let item2 = new CreateItem(2,'Modern Blazer', 'Formal Wear', 'https://raw.githubusercontent.com/Sihlandlo-schillo/HOSTEDIMAGES/main/images/Blazer.webp', '', 'Welcome to the future of homemade bread! This Stainless Steel Bread Maker, boasting 550W power, is your ticket to effortless baking bliss. With features like a 13-hour delay start and a 1-hour quick bake, enjoy fresh loaves tailored to your schedule. From customisable crusts to versatile settings, elevate your baking experience and savour the taste of perfection!', 1999)
...
let item5 = new CreateItem(5, 'Suit Bottoms', 'Formal Wear', 'https://sihlandlo-schillo.github.io/HOSTEDIMAGES/images/FormalWearBottom.webp', '', 'Crafted by the oldest Formal Wear designer in the world, and that is none other Schillo KOTM', 10000.00)

let item6 = new CreateItem(6,'ROLEX Oyster Perpetual 31', 'Accessories', 'https://asset.topwatch.co.za/ZA/stream/66696c5f3136373031385f323032342d30312d32332031323a32313a3034?filename=watch-club-rolex-oyster-perpetual-latest-release-green-dial-ref-277200-year-2020-14187-wb.jpgwbwbwbwb11.jpg&country_code=ZA','', 'Pre-owned, Unworn. This Timepiece has undergone a thorough inspection of water resistance, accuracy, functionality and condition to determine the level of reconditioning required to meet our strict standards. It has also been referenced against technical documents and manufacturer records where available to ensure authenticity and a clean history.', 145000)
...
function myProds() { 
    items.forEach(item =>{
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-secondary" id="view-More" data-bs-toggle="modal" data-bs-target="#exampleModal">View More</button>
